...
public class KeycloakLoginClient {
    ...
    public KeycloakLoginClient(
            ...
            @Value("${observability-mesh.auth.keycloak-token-url}") String tokenUrl,
            @Value("${observability-mesh.auth.keycloak-client-id:observability-mesh-ui}") String clientId,
            @Value("${observability-mesh.auth.keycloak-client-secret:}") String clientSecret) {
