...
class InstructionSecurityEventTest {
    ...
    void authorizedActionIncludesSnapshot() {
        var event = InstructionSecurityEvent.authorizedAction(
                ...
                objectMapper);
        assertThat(event.severity()).isEqualTo(com.observabilitymesh.instruction.model.SecurityEventSeverity.INFO);
    ...
    void policyDenialMarksAlert() {
        var event = InstructionSecurityEvent.policyDenial(
                ...
                Map.of(),
                objectMapper);
        assertThat(event.severity()).isEqualTo(com.observabilitymesh.instruction.model.SecurityEventSeverity.ALERT);
    }
}
