...
import com.observabilitymesh.sloprovisioner.web.dto.LoginRequest;
...
class AuthControllerTest {
    ...
    @Test
    void loginReturnsEmptySessionIdWhenMissing() {
        when(loginClient.login("user-001", "secret"))
                .thenReturn(new KeycloakLoginClient.LoginResponse("user-001", "token-1", null));
        Map<String, String> response = authController.login(new LoginRequest("user-001", "secret"));
        assertThat(response.get("session_id")).isEmpty();
    }
}
